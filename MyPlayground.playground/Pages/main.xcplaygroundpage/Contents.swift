...
// Answer to question 1 will be above becuase there was no deisgnated space. 
...
func isForceWith(jedi:String)-> Bool {
 if Jedi = Luke || Leia || Anakin || Obi Wan|| Yoda|| Vader {
        print("true")}
 } else {
   }
}
...
*/
func accountOnYolo(mine:Int, yours:Int)->Int{
